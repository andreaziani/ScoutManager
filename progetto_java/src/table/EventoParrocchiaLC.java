...
public class EventoParrocchiaLC {
	...
	public EventoParrocchiaLC(String codiceParrocchia, String codiceEvento, String tipo, String dataInizio,
	...
	public int inserimentoEvento() {
		try {
			PreparedStatement st = con.getMsSQLConnection().prepareStatement(
					"insert into E_P_LC(codiceParrocchia, codiceEvento, tipo, dataInizio, dataFine, località, descrizione) VALUES(?, ?, ?, ?, ?, ?, ?)");
